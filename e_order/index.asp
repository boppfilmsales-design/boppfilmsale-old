...
<title><%=trim(request("name"))%> Order,<%=e_webname%></title>
...
sql="select * from yuzhiguo_e_order"
...
set rs=nothing
	...
	set jmail = Nothing
	if SendMail="OK" then
	response.write"<script>alert('Order successfully!Your order is sent to the Webmaster E-mail!');location.href='../e_order/';</script>"
	else
	response.write"<script>alert('Order successfully!');location.href='../e_order/';</script>"
	end if
...
<div class="iproducts">   <div class="company_ico"><div align="center"></div></div>
	  <div class="company_title"><span class="ztitle">Order</span></div>
