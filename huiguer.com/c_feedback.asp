...
<tr>
<td colspan="9" align=center class="a1">中文留言管理</td>
</tr>
...
sql ="select * from yuzhiguo_feedback where name like '%"&keywords&"%' or content like '%"&keywords&"%' order by "&paixu&" "&xu&""
...
id=request("id")
set rs = server.CreateObject ("adodb.recordset")
sql="select * from yuzhiguo_feedback where id="& id &""
rs.open sql,conn,1,1
%>
...
<tr>
<td colspan="3" align=center class="a1">回复中文留言</td>
</tr>
<tr>
...
set rs=conn.execute("delete from yuzhiguo_feedback where id In(" & id & ")")
