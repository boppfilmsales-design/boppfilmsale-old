...
Dim s_StartFlag '小图片文件名 .开始. 结尾标识 例: 如果大图片文件名是“image1.gif”,结尾标识是“_small”,那么小图片文件名就是“image1_small.gif”
If Right(s_BuildBasePath, 1) <> "/" Then s_BuildBasePath = s_BuildBasePath & "/"
s_MapBuildBasePath = Server.MapPath(s_BuildBasePath)
s_StartFlag = "" '可以自定义,只要能区别大小图片即可
s_BuildFileName = s_StartFlag & Replace(s_OriginalFileName, s_OriginalFileExt, "") & s_OriginalFileExt
