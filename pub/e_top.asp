<div class="header">
  <div class="logo_l">
   <div class="logo">
  <% if logo<>"" then%><a href="<%=weburl%>"><img src="<%=webfolder%><%=get_pic(logo,1)%>" alt="<%=e_webname%>" border="0" /></a><%end if%>
  </div>
  
     <div class="company_name">
     <h1 class="company_name"><%=e_webname%></h1> </div>
                  </div>
...
%>
 <div style="width:100px; line-height:27px; float:left; text-align:center;">No Data</div>
<%else%>
<%do while not rs.eof%>
